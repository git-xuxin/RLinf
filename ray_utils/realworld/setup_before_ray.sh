...
export RLINF_COMM_NET_DEVICES="enp131s0" # Change this if you use a different network interface

# If you are using the docker image, change this to source switch_env franka-<version>, e.g., switch_env franka-0.15.0
source /home/xuxin/Workspace/Beijing/RLinf_zhz/.venv/bin/activate # Source your virtual environment here
...
# export RLINF_COMM_NET_DEVICES="enp3s0" # Change this if you use a different network interface

# # If you are using the docker image, change this to source switch_env franka-<version>, e.g., switch_env franka-0.15.0
# source /home/franka/Workspace/Beijing/RLinf_zhz/.venv/bin/activate # Source your virtual environment here
